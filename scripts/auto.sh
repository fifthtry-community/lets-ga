...
function run-ui() {
  ...
  echo "Using $FASTN to serve lets-ga.fifthtry.site/"
...
function update-www() {
  pushd2 "${PROJ_ROOT}/lets-ga.fifthtry-community.com" || return 1
  $FASTN update
  popd2
}
...
function run-www() {
  ...
  echo "Using $FASTN to serve lets-ga.fifthtry-community.com/"
